...
class SplitWord
{
    ...
    */
    ...
    {
		$this->addonDicFile = $_SERVER['DOCUMENT_ROOT'].'/'.$this->addonDicFile;
		$this->mainDicFile = $_SERVER['DOCUMENT_ROOT'].'/'.$this->mainDicFile;
		$this->mainDicFileZip = $_SERVER['DOCUMENT_ROOT'].'/'.$this->mainDicFileZip;
	...
	function InportDict( $targetfile )
     {
     	...
     	require_once( $_SERVER['DOCUMENT_ROOT'].'/'.'/zip.class.php');
     	$zip = new zip();
     	//echo $targetfile;
